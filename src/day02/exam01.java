...
public class exam01 {
    public static void main(String[] args) {
        ...
        System.out.println("홍길동");    //문자열은 " " 감싼자료, 문자는 ' ' 감싼 자료

        //2. 변수: 하나의 자료를 저장하는 메모리(저장소) 공간
        int age = 10 ;
        System.out.println(age);  //"age"는 문자열이라는 뜻, age는 키워드라는 뜻

        //3. 변수는 동일한 { }내 중복 이름이 불가능하다.
        String name = "유재석"; int age2 = 10;
        double height = 181.2; String motto = "좌우명";

        //4. +기호는 2가지 의미를 가진다. (1) + 더하기, 숫자+숫자 (2) 연결, 숫자+문자
        System.out.println("제 이름은 " + name + " , 나이는 " + age2 + "세, 키는 "+height + "cm 입니다." );

        //5. printf, 문자열 내 복잡한 수식이나 변수가 들어가는 자리에 형식으로 표현
